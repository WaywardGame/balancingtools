...
export default new Action()
	...
	.setHandler(action => {
		...
		for (const creatureType of [...creatureTypes, -1]) {
			...
			executor.island.creatures.spawn(creatureType, executor.island.getTile(x, y, executor.z), { bypassTiles: true, aberrant: false, bypassCreatureLimit: true });
			executor.island.creatures.spawn(creatureType, executor.island.getTile(x + 1, y, executor.z), { bypassTiles: true, aberrant: true, bypassCreatureLimit: true });
